...
CREATE TABLE IF NOT EXISTS event(
    ...
    user_id     int,
    event_type  varchar,    -- одно из значениий LIKE, REVIEW или FRIEND
    operation   varchar,    -- одно из значениий REMOVE, ADD, UPDATE
    entity_id   int,        -- идентификатор сущности, с которой произошло событие
